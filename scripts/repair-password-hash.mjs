...
if (loginStart < 0 || loginEnd < 0) throw new Error("Expected login password validation block was not found");
...
console.log(`Password hash repair complete; corrected ${writerCount} malformed writer(s).`);
